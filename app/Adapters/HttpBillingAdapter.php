        ...
        try {
            ...
            if (!is_array($data)) {
                throw new RuntimeException(
                    "Billing API [{$this->source}] returned non-array response on page {$page}"
                );
            }
            ...
            throw new RuntimeException(
                "Billing API [{$this->source}] request failed: " . $e->getMessage(),
                0,
                $e
            );
            ...
            throw new RuntimeException(
                "Billing API [{$this->source}] returned invalid JSON: " . $e->getMessage(),
                0,
                $e
            );
        }
